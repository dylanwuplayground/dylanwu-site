  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 h-screen w-64 bg-surface border-r border-border flex-col z-50">
        ...
        <nav className="flex-1 p-4 space-y-1">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-muted hover:text-text-bright hover:bg-surface-hover transition-colors group"
            >
        ...
        <div className="p-4 border-t border-border space-y-3">
          <div className="flex gap-3 px-3">
            <a
              href="https://www.linkedin.com/in/yilewu/"
              target="_blank"
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-surface border border-border rounded-lg text-text-muted hover:text-text-bright transition-colors"
