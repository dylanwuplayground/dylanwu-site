  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center px-6 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl">
        ...
        >
          <p className="text-primary font-mono text-[10px] tracking-[0.3em] uppercase mb-6">
            {hero.location}
          </p>
        </motion.div>
        ...
        >
          ...
          <br />
          <span className="text-text text-lg md:text-2xl font-normal tracking-normal leading-relaxed mt-4 block min-h-[2rem]">
